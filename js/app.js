...
alert('WELCOME TO TEAM APOLLO CARD PAGE BY AVWUNUDIOGBA ANDREW');
...
let apolloTeam = ['nutjob', 'drew', 'ladel', 'stanleyceejay','krisemeka'];
...
let intro = {
    firstName: 'Andrew',
    lastName: 'avwunudiogba',
    bestMovie: '300 Spatans',
    bestFood: 'eba',
...
let noun= "school", verb= "walks", adjective = "big";

let firstSentence = "The" + " " + noun + " " + "is" + " " + adjective;

console.log(firstSentence);

let secondSentence = "He" + " " + verb + " " + "to" + " " + noun;

console.log(secondSentence);

let thirdSentence = "He" + " " + "loves" + " " + "his" + " " +adjective +" " + noun ;

console.log(thirdSentence);

let fourthSentence = "Andrew goes to a" + " " + adjective + " " + noun;

console.log(fourthSentence);

let fifthSentence = "Mr adamu runs a" + " " + adjective + " " + noun + " " + "he" + " " + verb +" " + "to." ;
...
remainderX = (number1, number2) => {
    let remainderX = number1 % number2;
    return [remainderX]
}

console.log(remainderX(25, 3));
// ////////////////////////////////   question 6 Solution. ///////////////////////////////
...
const wordBlanks = `Andrew has a ${myAdjective} ${myNoun} that ${myVerb} ${myAdverb}. `;
